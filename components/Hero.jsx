    ...
    return (
        <div className='mx-6'>
            <div className='flex max-xl:flex-col gap-8 max-w-7xl mx-auto my-10'>
                <div className='relative flex-1 flex flex-col bg-blue-400 rounded-3xl xl:min-h-100 group'>
                    <div className='p-5 sm:p-16'>
                        <div className='inline-flex items-center gap-3 bg-blue-700 text-white pr-4 p-1 rounded-full text-xs sm:text-sm'>
                        ...
                        <h2 className='text-3xl sm:text-5xl leading-[1.2] my-3 font-medium bg-gradient-to-r from-blue-900 to-blue-700 bg-clip-text text-transparent max-w-xs sm:max-w-md'>
